			...
			<view class="info">
				<view class="info-contain">
					...
					<view class="info-date" @click="this.isShow=true">
						...
						<hTimeAlert title="预约时间" subhead='请选择需要上门服务的时间' rangeDay="5" intervalTime="30" :isShow="isShow" @closeAlert="handelClose" class="hTimeAlert" rangeStartTime="18:00:00" rangeEndTime="21:00:00" dayStartIntTime="60"></hTimeAlert>
					</view>

		...
		<view class="ithui-view">
			<view class="view-info">
				<view class="userinfo">
					<view class="flex">
						<view class="flex-one">
							<view class="flex-one-text">用户名：{{ userData.name }}</view>
				...
				<view class="box">
					<view class="tx">
						...
						<view class="tx-grid" @click="navTo('/pages/withdraw/withdraw')"><span
				...
				<view class="top">
					<u-subsection :list="tabs" fontSize="22" activeColor="#ff8440" :current="tabIndex"

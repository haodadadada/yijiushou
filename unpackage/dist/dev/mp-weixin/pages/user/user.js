...
var _user = _interopRequireDefault(__webpack_require__(/*! ./pages/user/user.vue */ 201));
// @ts-ignore
...
/* harmony import */ var _user_vue_vue_type_template_id_80842834___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user.vue?vue&type=template&id=80842834& */ 202);
...
/* harmony import */ var _user_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user.vue?vue&type=style&index=0&lang=scss& */ 211);
...
try {
  components = {
    uNavbar: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-navbar/u-navbar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-navbar/u-navbar")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-navbar/u-navbar.vue */ 428))
    },
    uIcon: function () {
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      orders: [{
        id: 1,
        icon: __webpack_require__(/*! ../../static/order-1.png */ 206),
        title: '全部'
      }, {
        id: 2,
        icon: __webpack_require__(/*! ../../static/order-2.png */ 207),
        title: '待服务'
      }, {
        id: 3,
        icon: __webpack_require__(/*! ../../static/order-5.png */ 208),
        title: '已完成'
      }
      /* {
      	id: 4,
      ...
      tools: [{
        url: '../address/address',
        icon: __webpack_require__(/*! ../../static/tools-2.png */ 209),
        title: '地址管理',
        show: true
      }, {
        url: '../feedback/feedback',
        icon: __webpack_require__(/*! ../../static/tools-3.png */ 210),
        title: '意见反馈',
        show: true
      }],
      bannerList: [],
